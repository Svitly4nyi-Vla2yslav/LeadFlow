...
export const GlobalStyle = createGlobalStyle`
  *{box-sizing:border-box} html,body,#root{height:100%;min-width:0} html,body{overflow-x:hidden}
  ...
  .page-stack{display:grid;gap:14px;min-width:0}.muted{opacity:.68}.error-text{color:#fca5a5}.success-text{color:#86efac}.mobile-only{display:none}.table-scroll{overflow-x:auto;max-width:100%}
  ...
  .import-preview{display:grid;gap:8px;max-height:260px;overflow:auto;margin:10px 0}.import-preview pre{min-width:0;overflow:auto;margin:0;padding:10px;border-radius:8px;background:rgba(0,0,0,.3);font-size:11px}
  .lead-card{display:grid;gap:10px;padding:14px;border:1px solid rgba(255,255,255,.12);border-radius:14px;background:rgba(255,255,255,.035)}.lead-card p,.lead-card h3{margin:0}.lead-card-head{display:flex;align-items:flex-start;justify-content:space-between;gap:10px}.phone-link{font-size:17px;font-weight:700}.line-clamp{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.action-link{min-height:44px;display:grid;place-items:center;flex:1;padding:9px 12px;border:1px solid rgba(255,255,255,.18);border-radius:11px;text-align:center}.action-link.primary{background:rgba(99,102,241,.7);color:#fff}
